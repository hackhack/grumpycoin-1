...
uint256 hashGenesisBlock("0x4f90163c88c64033da93c8b412b1fb483798db68d2e8cd7ed7aafc70f798d8ee");
...
const string strMessageMagic = "GrumpyCoin Signed Message:\n";
...
static const int64 nTargetTimespan = 8 * 60 * 60; // GrumpyCoin: 1 days
static const int64 nTargetSpacing = 120; // GrumpyCoin: 2 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal grumpycoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "GrumpyCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "GrumpyCoin";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1388702434; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1388910;

        if (fTestNet)
        {
            block.nTime    = 1388702434;
            block.nNonce   = 0;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x8fb3add90869cb86516a294708453eed17104bb8128f0d67bba1aa434f2f1a19"));
